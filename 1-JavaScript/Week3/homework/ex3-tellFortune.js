...
function main() {
  const numKids = [1, 4, 5, 6, 7];

  const partnerNames = ['sara', 'sarah', 'Mille', 'Iris', 'Lisbon'];

  const locations = ['Yemen', 'Netherlands', 'Turkey', 'Syria', 'Morocco'];

  const jobTitles = ['Teacher', 'Engineer', 'Doctor', 'Actor', 'Driver'];
