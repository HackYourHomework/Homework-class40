...
function tellFortune(numKids, partnerNames, locations, jobTitles) {
  ...
  const message = `You will be a ${jobTitle} in ${location}, 
...
function main() {
  ...
  const locations = ['Amsterdam', 'Balk', 'lemmer', 'Sneek', 'Rotterdam'];
  const jobTitles = ['manager', 'webdeveloper', 'Writer', 'worker', 'police'];
