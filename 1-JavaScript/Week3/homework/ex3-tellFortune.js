...
function selectRandomly(array) {
  const randomArrayPick = Math.floor(Math.random() * array.length);
  return array[randomArrayPick];
}
...
function main() {
  ...
  const partnerNames = ['Waves', 'Jack', 'George', 'Jeniffer', 'Lisa'];

  const locations = ['Angara', 'Buca', 'Sincan', 'Antwerp', 'Amsterdam'];

  const jobTitles = ['Programmer', 'Teacher', 'Amele', 'Soldier', 'Doctor'];
