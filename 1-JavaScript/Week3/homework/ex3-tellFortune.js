...
function main() {
  const numKids = [2, 4, 5, 3, 1];

  const partnerNames = ['Sam', 'Julian', 'Basil', 'Jacob', 'Leonardo'];

  const locations = ['London', 'Paris', 'Barcelona', 'Roma', 'Bucharest'];

  const jobTitles = ['astronaut', 'potter', 'singer', 'gardener', 'actor'];
