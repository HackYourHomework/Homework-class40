...
function selectRandomly(annArry) {
  let randomIndex = ~~(Math.random()* annArry.length);
  let elementName = annArry[randomIndex];
  return elementName;
}
...
function main() {
  ...
  const partnerNames = [
    "Salama","Lila","Sumea","Abeer","Elham"
  ];

  const locations = [
    "Amsterdam","Dventer","DenHaag","Eindhoven","Lebonon"
  ];

  const jobTitles = [
    "Doctor","Teacher","Engineer","Contractor","Businessman"
  ];
