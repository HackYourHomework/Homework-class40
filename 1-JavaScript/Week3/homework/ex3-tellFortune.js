...
function main() {
  const numKids = [  5 , 2 , 3 , 4 , 1 ];

  const partnerNames = [ 'Ramses' , 'Amon' , 'Raa' , 'Anubis' , 'Horus' ];

  const locations = [ 'Cairo' , 'Amsterdam' , 'Miami' , 'Dubai' , 'Luxor' ]

  const jobTitles = [ 'Programmer' , ' Doctor' , 'Artist' , 'Engineer' , 'scientist' ];
