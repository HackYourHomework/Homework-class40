...
function main() {
  rollDie()
    .then(function (resolve) {
      console.log(`Success! Die settled on ${resolve}.`);
    })
...
//My explanation...
//>> We are sending "callback(null, value)" so because of the null, this main function give "Success..." message to us.
//>> With promise we can separate and manage the callbacks as success and failure
