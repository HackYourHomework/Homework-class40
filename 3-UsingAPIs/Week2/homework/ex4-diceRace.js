...
//When we use Promise.race(), we are just getting a notification when the first async operation finishes. The other async operations will still run to their normal completion.
